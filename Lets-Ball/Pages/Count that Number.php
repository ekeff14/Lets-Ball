...
<body>
  ...
  <h1 class="white">
      ...
      <div class="gamebox">
        ...
        <a href="Count that Number(EASY).html"><img src="../CSS/Images/" id="minigameimg1" alt="Play First Edition"></a>
        ...
        <a href="Count that Number(MEDIUM).html"><img src="../CSS/Images/" id="minigameimg2" alt="Play Second Edition"></a>
